...
public class Crud {
    ...
    private JTextField Db_Select;
    private JTextField Db_From;
    ...
    public Crud() {
        ...
        Db_SelectGo.addActionListener(new ActionListener() {
            @Override
        ...
        Db_Table.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                id_prod = Tb_click.getValueAt(Db_Table.getSelectedRow(),0).toString();
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (resposta == JOptionPane.YES_OPTION) {
                    try {
                        ...
                        stm.setInt(3, Integer.parseInt(Form_qtde.getText()));
                        stm.setDouble(4, Double.parseDouble(Form_Preco.getText()));
                        stm.setInt(5,Integer.parseInt(id_prod));
                        stm.execute();
                        stm.close();
